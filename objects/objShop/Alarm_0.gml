...
var _space = 140;
var _item1 = instance_create_depth(x - _space,y + _space/3,0,objItemShop, {
...
var _item2 = instance_create_depth(x,y + _space/3,0,objItemShop, {
...
var _item3 = instance_create_depth(x + _space,y + _space/3,0,objItemShop, {
...
var _up1 = instance_create_depth(x - _space,y+256,0,objUpgrade, 
{description: "+15 MAXHP",cost: 0});
_up1.image_index = 0;
var _up2 = instance_create_depth(x,y+256,0,objUpgrade, 
{description: "+1 REFRESH",cost: 0});
_up2.image_index = 1;
var _up3 = instance_create_depth(x + _space,y+256,0,objUpgrade, 
{description: "+1 MOVE PER BOARD",cost: 0});
_up3.image_index = 2;
